 ...
 * @return string
 */
function getReference($findValue, $fromTable, $fromField, $returnValueFromField, $customQuery = "") {
 ...
 * @return array
 */
function getDataRowsInArray($fields, $tables, $filterFields, $expressionValues, $orderBy, $customQuery = "") {
 ...
 */
function getComboList($primaryKeyFieldName, $valueFieldName, $tableName, $orderBy, $selectedValue, $defaultText, $customQuery = "") {
...
function getListBoxList($primaryKeyFieldName, $valueFieldName, $tableName, $orderBy, $selectedValue, $defaultText, $customQuery = "") {
 ...
 * @return boolean
 */
function isDuplicate($findValue, $findValueInColumn, $tableName, $customQuery) {
 ...
 * @return integer
 */
function countRow($findValue, $findValueInColumn, $tableName, $customQuery) {
 ...
 * @return integer
 */
function getMaxId($fieldName, $tableName, $customQuery) {
...
function isDuplicate1($findValue, $findValueInColumn, $tableName, $customQuery) {
