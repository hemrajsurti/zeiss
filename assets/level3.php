        ...
        <div class="puzzle-body">
            <div class="puzzle">
                ...
                <div id="container">
                    ...
                    <button class="nextlevel" onclick="location.href = 'level4.php';">Next Level</button>
                    <div id="gamebody">
                        <div class="dropbox">
                            <img src="img/img_1017.png" />
                        </div>
                        <div class="drags">
                       		 <img src="images/image_d/1.png" class="drag drag5 wow zoomIn" data-wow-delay="0.1s" />
                            <img src="images/image_d/2.png" class="drag drag6 wow zoomIn" data-wow-delay="0.2s" />
                            <img src="images/image_d/3.png" class="drag drag1 wow zoomIn" data-wow-delay="0.3s" />
                            <img src="images/image_d/4.png" class="drag drag3 wow zoomIn" data-wow-delay="0.5s"/>
                            <img src="images/image_d/5.png" class="drag drag16 wow zoomIn" data-wow-delay="0.6s"/>
                            <img src="images/image_d/6.png" class="drag drag15 wow zoomIn" data-wow-delay="0.7s"/>
                            <img src="images/image_d/7.png" class="drag drag4 wow zoomIn" data-wow-delay="0.9s"/>
                            <img src="images/image_d/8.png" class="drag drag7 wow zoomIn" data-wow-delay="1s"/>
                            <img src="images/image_d/9.png" class="drag drag8 wow zoomIn" data-wow-delay="1.1s"/>
                            <img src="images/image_d/10.png" class="drag drag10 wow zoomIn" data-wow-delay="1.3s"/>
                            <img src="images/image_d/11.png" class="drag drag13 wow zoomIn" data-wow-delay="1.4s"/>
                            <img src="images/image_d/12.png" class="drag drag9 wow zoomIn" data-wow-delay="1.5s"/>
                            <img src="images/image_d/13.png" class="drag drag2 wow zoomIn" data-wow-delay="1.3s"/>
                            <img src="images/image_d/14.png" class="drag drag11 wow zoomIn" data-wow-delay="1.4s"/>
                            <img src="images/image_d/15.png" class="drag drag12 wow zoomIn" data-wow-delay="1.5s"/>
        ...
        <div class="footer">
            <div class="col col1">
                <p class="wow fadeInLeft " data-wow-delay="1.2s">Level:
                    <br>
                    <strong id="level">3</strong>
                </p>
            </div>
            <div class="col col2">
                <img src="img/img_1017.png" id="ac_img" style="display:none;" class="puzzle new wow zoomInDown" data-wow-delay="1.4s" data-wow-duration="2s">
