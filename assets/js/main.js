...
var tparr = ["1", "6", "5", "2", "3", "16", "15", "14", "4", "7", "8", "11", "10", "13", "9", "12"];
...
$(document).ready(function () {
    ...
    $(".drag1").draggable({
        drag: function () {
            temp = c;
            $(".drag1").css("height", "51px");
            $(".drag1").css("width", "113px");
            $(".drag1").css("z-index", "1");
        },
        stop: function () {
            if (c == temp) {
    ...
    $(".drag5").draggable({
        drag: function () {
            temp = c;
            $(".drag5").css("height", "91px");
            $(".drag5").css("width", "169px");
            $(".drag5").css("z-index", "1");
        },
        stop: function () {
            if (c == temp) {
    ...
    $(".drop7").droppable({
        ...
        drop: function (event, ui) {
            $(".drag15").css("top", "119px");
            $(".drag15").css("height", "124px");
            $(".drag15").css("width", "153px");
            $(".drag15").css("left", "386px");
            $(".drag15").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop8").droppable({
        ...
        drop: function (event, ui) {
            $(".drag14").css("top", "215px");
            $(".drag14").css("height", "70px");
            $(".drag14").css("width", "214px");
            $(".drag14").css("left", "356px");
            $(".drag14").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop12").droppable({
        ...
        accept: ".drag11",
        drop: function (event, ui) {
            $(".drag11").css("top", "198px");
            $(".drag11").css("height", "87px");
            $(".drag11").css("width", "152px");
            $(".drag11").css("left", "522px");
            $(".drag11").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop16").droppable({
        ...
        accept: ".drag12",
        drop: function (event, ui) {
            $(".drag12").css("top", "219px");
            $(".drag12").css("height", "66px");
            $(".drag12").css("width", "171px");
            $(".drag12").css("left", "626px");
            $(".drag12").draggable({
                disabled: true
            });
            c++;
