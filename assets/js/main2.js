...
var tparr = ["5", "6", "1", "2", "3", "16", "15", "14", "4", "7", "8", "11", "10", "13", "9", "12"];
...
$(document).ready(function () {
    ...
    $(".drop4").droppable({
        ...
        drop: function (event, ui) {
            $(".drag3").css("top", "0px");
            $(".drag3").css("height", "80px");
            $(".drag3").css("width", "156px");
            $(".drag3").css("left", "394px");
            $(".drag3").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop5").droppable({
        ...
        drop: function (event, ui) {
            ...
            $(".drag16").css("width", "196px");
            $(".drag16").css("left", "363px");
            $(".drag16").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop6").droppable({
        ...
        drop: function (event, ui) {
            $(".drag15").css("top", "158px");
            $(".drag15").css("height", "89px");
            $(".drag15").css("width", "162px");
            $(".drag15").css("left", "398px");
            $(".drag15").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop7").droppable({
        ...
        drop: function (event, ui) {
            $(".drag4").css("left", "488px");
            $(".drag4").css("top", "0px");
            $(".drag4").css("height", "80px");
            $(".drag4").css("width", "160px");
            $(".drag4").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop8").droppable({
        ...
        drop: function (event, ui) {
            $(".drag7").css("top", "60px");
            $(".drag7").css("height", "118px");
            $(".drag7").css("width", "158px");
            $(".drag7").css("left", "522px");
            $(".drag7").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop9").droppable({
        ...
        drop: function (event, ui) {
            $(".drag8").css("top", "158px");
            $(".drag8").css("height", "89px");
            $(".drag8").css("width", "122px");
            $(".drag8").css("left", "526px");
            $(".drag8").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop10").droppable({
        ...
        drop: function (event, ui) {
            $(".drag10").css("top", "0px");
            $(".drag10").css("height", "80px");
            $(".drag10").css("width", "146px");
            $(".drag10").css("left", "617px");
            $(".drag10").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop11").droppable({
        ...
        drop: function (event, ui) {
            $(".drag13").css("top", "60px");
            $(".drag13").css("height", "118px");
            $(".drag13").css("width", "115px");
            $(".drag13").css("left", "648px");
            $(".drag13").draggable({
                disabled: true
            });
            c++;
    ...
    $(".drop12").droppable({
        ...
        drop: function (event, ui) {
            $(".drag9").css("top", "158px");
            $(".drag9").css("height", "89px");
            $(".drag9").css("width", "145px");
            $(".drag9").css("left", "618px");
            $(".drag9").draggable({
                disabled: true
            });
            c++;
